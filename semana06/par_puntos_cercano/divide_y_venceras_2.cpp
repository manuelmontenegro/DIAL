...
// coste n log^2 n, porque cada llamada a `par_puntos_franja` ordena el vector
// de manera ascendente según la coordenada y.
...
Solucion par_puntos_franja(vector<Punto> &franja, double d) {
  ...
  sort(franja.begin(), franja.end(), comparar_y);
